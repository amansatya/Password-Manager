...
const Manager = () => {
    ...
    const showPassword = () => {
        ...
        ref.current.src = isHidden ? "icons/eyecross.png" : "icons/eye.png"
    }
    ...
    const handleEditSave = async (updatedData) => {
        ...
        await fetch("http://localhost:3000/", {
            method: "DELETE",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ id: updatedData.id })
        })
        ...
        <>
            ...
            <div className=" p-3 md:mycontainer min-h-[88.2vh] ">
                ...
                <div className="flex flex-col p-4 text-black gap-8 items-center">
                    ...
                    <button onClick={savePassword} className='cursor-pointer flex justify-center items-center gap-2 bg-green-400 hover:bg-green-300 rounded-full px-8 py-2 w-fit border border-green-900'>
                        <lord-icon
